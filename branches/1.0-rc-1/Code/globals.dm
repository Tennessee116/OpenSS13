...
</li><li>Un-nerfed meteor chance in non-meteor modes a bit from 0.5 to 1 (originally 2.0 before it was nerfed to 0.5). (Note: at 0.5 it was actually 0% due to a quirk in BYOND's prob function)
